<template>
  <div>
    ...
    <ul>
      ...
      <li v-ranking="90">WordPress</li>
      <li v-ranking="80">
        PHP
        <!--  <small> (top 5% on LinkedIn assessment) </small> -->
      </li>
      <li v-ranking="60">MySQL / MariaSQL</li>
